...
1. **add_event** — 新增行程（支援週期性，支援一次多筆）
   - 單筆行程：{"action": "add_event", "data": {"title": "看牙醫", "date": "2025-07-05", "time": "14:00", "recurrence": ""}}
   - 多筆行程：{"action": "add_event", "data": {"items": [{"title": "看牙醫", "date": "2025-07-05", "time": "14:00", "recurrence": ""}, {"title": "開會", "date": "2025-07-06", "time": "10:00", "recurrence": ""}]}}
...
19. **add_birthday** — 新增生日或紀念日（支援國曆和農曆，支援一次多筆）
...
26. **draft_reply** — 代擬回覆稿（LINE 或 EMAIL 回信）
...

{
  ...
  "amount": "金額文字或空字串",
  "action_needed": "給使用者的建議（例如名片→'將聯絡資訊存入手機通訊錄'），沒有就空字串"
}
